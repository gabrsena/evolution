...
const PoolPageContent = () => {
  ...
  const customWhatsAppMessage = "Hi, I'm interested in a pool installation or renovation project for my home in Central Florida.";
      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            >
              <WhatsAppIcon />
              <span>Get a Free Pool Consultation</span>
            </a>
          </div>
        </div>
      </section>
