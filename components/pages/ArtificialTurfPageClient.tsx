...
const PROCESS_STEPS = [
  { step: "01", title: "Consultation", desc: "Detailed measurement and site inspection to understand your landscaping goals." },
  { step: "02", title: "Base Preparation", desc: "Excavation, grading, and compacting aggregate base to ensure flawless drainage." },
  { step: "03", title: "Turf Installation", desc: "Precision cutting, seaming, securing, and adding premium infill materials." },
  { step: "04", title: "Final Grooming", desc: "Power brushing and walkthrough to ensure every blade is upright and beautiful." }
];

const FAQS = [
  {
    q: "How long does artificial turf last?",
    a: "Quality turf lasts 15–25 years with minimal maintenance."
  },
  {
    q: "Is it safe for pets?",
    a: "Yes — we use pet-friendly, non-toxic materials that are easy to clean."
  },
  {
    q: "Can it be installed around a pool?",
    a: "Absolutely. It's one of the most popular pool deck surfaces in Florida."
  },
  {
    q: "How much does it cost?",
    a: "Cost depends on square footage and base preparation. We provide free on-site estimates."
  }
];
    ...
    <div className="app-container">
      ...
      >
        ...
        >
          ...
          >
            Premium Artificial Turf Installation for Florida Homes
          </h1>
          <p 
            style={{ 
          ...
          >
            Lush, realistic turf that stays green year-round — zero watering, zero mowing, perfect for Florida's climate.
          </p>
        ...
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '64px' }}>
            ...
            <h2 className="section-headline" style={{ marginTop: '8px', color: '#111827', fontFamily: "'Cormorant Garamond', serif" }}>
              Why Choose Elevation for Artificial Turf
            </h2>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '32px' }}>
            <div style={{ background: '#ffffff', borderRadius: '12px', padding: '40px 32px', boxShadow: '0 10px 30px rgba(0, 0, 0, 0.03)', border: '1px solid #f3f4f6' }}>
              ...
              <h3 style={{ fontSize: '22px', fontWeight: 700, marginBottom: '16px', color: '#111827', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Zero Maintenance</h3>
              <p style={{ color: '#4b5563', fontSize: '15px', lineHeight: '1.6' }}>No watering, mowing or fertilizing. Just clean, green grass every day of the year.</p>
            </div>
            ...
            <div style={{ background: '#ffffff', borderRadius: '12px', padding: '40px 32px', boxShadow: '0 10px 30px rgba(0, 0, 0, 0.03)', border: '1px solid #f3f4f6' }}>
              ...
              <h3 style={{ fontSize: '22px', fontWeight: 700, marginBottom: '16px', color: '#111827', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Pet & Kid Friendly</h3>
              <p style={{ color: '#4b5563', fontSize: '15px', lineHeight: '1.6' }}>Durable, non-toxic materials safe for the whole family. Easy to clean and odor-resistant.</p>
            </div>
            ...
            <div style={{ background: '#ffffff', borderRadius: '12px', padding: '40px 32px', boxShadow: '0 10px 30px rgba(0, 0, 0, 0.03)', border: '1px solid #f3f4f6' }}>
              ...
              <h3 style={{ fontSize: '22px', fontWeight: 700, marginBottom: '16px', color: '#111827', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Saves Water & Money</h3>
              <p style={{ color: '#4b5563', fontSize: '15px', lineHeight: '1.6' }}>Eliminate your irrigation bill entirely. Artificial turf pays for itself in savings.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section fade-in-section" style={{ background: '#ffffff', padding: '80px 24px', color: '#111827', textAlign: 'center' }}>
        <div className="container" style={{ maxWidth: '1000px', margin: '0 auto' }}>
          ...
          <p style={{ color: '#6B7280', fontSize: '16px', marginBottom: '32px', margin: '0 auto 32px', maxWidth: '600px' }}>
            We provide professional artificial turf installation for homeowners across Central Florida.
          </p>
      ...
      <TestimonialSection />
      <Footer />
      <FloatingWhatsApp customMessage="Hi, I'm interested in an artificial turf project for my home in Central Florida." />
    </div>
  );
};

export default function ArtificialTurfPageClient() {
  return (
    <TranslationProvider>
      <TurfPageContent />
    </TranslationProvider>
